...
🔹 Через наш сайт вы можете записаться на прием к специалистам
🔹 Я буду присылать вам коды подтверждения для записи
🔹 Все коды действительны 10 минут

Чтобы записаться на прием:
1️⃣ Перейдите на сайт больницы
2️⃣ Выберите врача, дату и время
3️⃣ Укажите ваш номер телефона
4️⃣ Я пришлю код подтверждения сюда, в этот чат
...
Чтобы записаться на прием, перейдите на сайт больницы."""
